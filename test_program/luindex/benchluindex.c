...
int main(){
    ...
    int sched_set_flag=sched_setscheduler(getpid(),SCHED_FIFO,&param);
    printf("%d\n",sched_set_flag);
...
//    execlp("taskset","taskset","-pc","3",pid,NULL);
  //  printf("hello");
    execlp("taskset","taskset","-c","0,1,2,3","java","-jar","/home/huang/Desktop/NEU-Design/dacapo-9.12-MR1-bach.jar","luindex","-s","default","-n","20",NULL);
}
